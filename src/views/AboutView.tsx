...
export const AboutView: React.FC<AboutViewProps> = ({ onNavigate, onOpenAdmissionModal }) => {
  ...
  const campusFeatures = {
    classrooms: {
      ...
      image: '/gallery/Photos/First_day_at_school.jpeg',
      bullets: [
    ...
    outdoors: {
      ...
      image: '/gallery/Photos/Rainy_day_activity.jpeg',
      bullets: [
    ...
    sensory: {
      ...
      image: '/gallery/Photos/Colour%27s_day_activity_2.jpeg',
      bullets: [
    ...
    safety: {
      ...
      image: '/gallery/Photos/doctor%27s_day_.jpeg',
      bullets: [
  ...
  return (
    <div id="about-page-container" className="w-full bg-[#FFF9EC]">
      ...
      {/* Leadership & Advisory Team — REMOVED per user request */}
